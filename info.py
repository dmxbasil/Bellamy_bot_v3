...
BOT_TOKEN = environ.get('BOT_TOKEN', "7348469767:AAEM43rgt75fWs0qY9aYZri_Adu-s-UJ7pI")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/0e040ad33279cba04b70b.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/0e040ad33279cba04b70b.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001247120413 -1002212689900').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002169850887')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "bellamy-v3")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'bellamy-v3')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/0e040ad33279cba04b70b.jpg')
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>- ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs - \n\n- 30ʀs - 1 ᴡᴇᴇᴋ\n- 50ʀs - 1 ᴍᴏɴᴛʜs\n- 120ʀs - 3 ᴍᴏɴᴛʜs\n- 220ʀs - 6 ᴍᴏɴᴛʜs\n\n🎁 ᴘʀᴇᴍɪᴜᴍ ғᴇᴀᴛᴜʀᴇs 🎁\n\n○ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪғʏ\n○ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ\n○ ᴅɪʀᴇᴄᴛ ғɪʟᴇs\n○ ᴀᴅ-ғʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ\n○ ʜɪɢʜ-sᴘᴇᴇᴅ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ\n○ ᴍᴜʟᴛɪ-ᴘʟᴀʏᴇʀ sᴛʀᴇᴀᴍɪɴɢ ʟɪɴᴋs\n○ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs\n○ ꜰᴜʟʟ ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ\n○ ʀᴇǫᴜᴇsᴛ ᴡɪʟʟ ʙᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ 1ʜ ɪꜰ ᴀᴠᴀɪʟᴀʙʟᴇ\n\n✨ ᴜᴘɪ ɪᴅ - <code>jivshn@okaxis</code>\n\nᴄʟɪᴄᴋ ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ /myplan\n\n💢 ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ\n\n‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ</b>')
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'basildmx') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/dmx_chating')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/dmx_chating')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'dmx_chating') # Support Chat Link Without https:// or @
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.shrinkme.io')
SHORTLINK_API = environ.get('SHORTLINK_API', '1187d8b7c3e869218765eeae775f838ed716aa98')
...
LANGUAGES = ["ᴍᴀʟᴀʏᴀʟᴀᴍ", "മലയാളം", "ᴛᴀᴍɪʟ", "தமிழ்" ,"ᴇɴɢʟɪꜱʜ", "eng", "ʜɪɴᴅɪ", "हिंदी", "ᴛᴇʟᴜɢᴜ", "తెలుగు", "ᴋᴀɴɴᴀᴅᴀ", "ಕನ್ನಡ"]
SEASONS = ["ꜱᴇᴀꜱᴏɴ 1", "ꜱᴇᴀꜱᴏɴ 2", "ꜱᴇᴀꜱᴏɴ 3", "ꜱᴇᴀꜱᴏɴ 4", "ꜱᴇᴀꜱᴏɴ 5", "ꜱᴇᴀꜱᴏɴ 6", "ꜱᴇᴀꜱᴏɴ 7", "ꜱᴇᴀꜱᴏɴ 8", "ꜱᴇᴀꜱᴏɴ 9", "ꜱᴇᴀꜱᴏɴ 10"]
